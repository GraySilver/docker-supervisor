...
from docker_supervisor.tests.base import DummyRPCServer

class ControllerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.supervisorctl import Controller
        return Controller
...
class TestControllerPluginBase(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.supervisorctl import ControllerPluginBase
