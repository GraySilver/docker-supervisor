...
from docker_supervisor.tests.base import DummyRPCInterfaceFactory
from docker_supervisor.tests.base import DummyPConfig
from docker_supervisor.tests.base import DummyOptions
from docker_supervisor.tests.base import DummyRequest
...
class LogtailHandlerTests(HandlerTests, unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import logtail_handler
...
class MainLogTailHandlerTests(HandlerTests, unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import mainlogtail_handler
...
class TailFProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import tail_f_producer
...
class DeferringChunkedProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import deferring_chunked_producer
...
class DeferringCompositeProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import deferring_composite_producer
...
class DeferringGlobbingProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import deferring_globbing_producer
...
class DeferringHookedProducerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import deferring_hooked_producer
...
class EncryptedDictionaryAuthorizedTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import encrypted_dictionary_authorizer
...
class SupervisorAuthHandlerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import supervisor_auth_handler
...
class LogWrapperTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.http import LogWrapper
        return LogWrapper
