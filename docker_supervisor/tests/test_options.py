...
from docker_supervisor.loggers import LevelsByName

from docker_supervisor.tests.base import DummySupervisor
from docker_supervisor.tests.base import DummyLogger
from docker_supervisor.tests.base import DummyOptions
from docker_supervisor.tests.base import DummyPConfig
from docker_supervisor.tests.base import DummyProcess
from docker_supervisor.tests.base import DummySocketConfig
from docker_supervisor.tests.base import lstrip

class OptionTests(unittest.TestCase):

    def _getTargetClass(self):
        from docker_supervisor.options import Options
        return Options
...
class ClientOptionsTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.options import ClientOptions
...
class ServerOptionsTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.options import ServerOptions
    ...
    def test_version(self):
        from docker_supervisor.options import VERSION
    ...
    def test_options(self):
        ...
        from docker_supervisor import datatypes
    ...
    def test_readFile_failed(self):
        from docker_supervisor.options import readFile
        try:
    ...
    def test_check_execv_args_cant_find_command(self):
        instance = self._makeOne()
        from docker_supervisor.options import NotFound
        self.assertRaises(NotFound, instance.check_execv_args,
                          '/not/there', None, None)

    def test_check_execv_args_notexecutable(self):
        instance = self._makeOne()
        from docker_supervisor.options import NotExecutable
    ...
    def test_options_afunix(self):
        ...
        ; ...
        """)
        from docker_supervisor.options import UnhosedConfigParser
    ...
    def test_event_listener_pool_with_event_result_handler(self):
        ...
        """)
        from docker_supervisor.options import UnhosedConfigParser
        from docker_supervisor.tests.base import dummy_handler
        config = UnhosedConfigParser()
        config.read_string(text)
        instance = self._makeOne()
        gconfigs = instance.process_groups_from_parser(config)
    ...
    def test_fcgi_programs_from_parser(self):
        from docker_supervisor.options import FastCGIGroupConfig
        from docker_supervisor.options import FastCGIProcessConfig
        text = lstrip("""\
        [fcgi-program:foo]
...
class TestProcessConfig(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.options import ProcessConfig
...
class EventListenerConfigTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.options import EventListenerConfig
    ...
    def test_make_dispatchers(self):
        ...
        try:
            ...
            self.assertEqual(dispatchers[5].channel, 'stdout')
            from docker_supervisor.states import EventListenerStates
...
class ProcessGroupConfigTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.options import ProcessGroupConfig
...
class EventListenerPoolConfigTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.options import EventListenerPoolConfig
...
class SignalReceiverTests(unittest.TestCase):
    def test_returns_None_initially(self):
        from docker_supervisor.options import SignalReceiver
        sr = SignalReceiver()
...
class UtilFunctionsTests(unittest.TestCase):
    def test_make_namespec(self):
        from docker_supervisor.options import make_namespec
