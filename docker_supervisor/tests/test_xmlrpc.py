...
from docker_supervisor.tests.base import DummySupervisorRPCNamespace
...
class XMLRPCHandlerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.xmlrpc import supervisor_xmlrpc_handler
...
class SupervisorTransportTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.xmlrpc import SupervisorTransport
...
class TestDeferredXMLRPCResponse(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.xmlrpc import DeferredXMLRPCResponse
    ...
    def test_more_callback_raises_RPCError(self):
        from docker_supervisor.xmlrpc import RPCError, Faults
        def callback():
...
class TestSystemNamespaceRPCInterface(unittest.TestCase):
    def _makeOne(self, namespaces=()):
        from docker_supervisor.xmlrpc import SystemNamespaceRPCInterface
...
class Test_gettags(unittest.TestCase):
    def _callFUT(self, comment):
        from docker_supervisor.xmlrpc import gettags
