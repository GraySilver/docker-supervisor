...
from docker_supervisor.tests.base import DummyStream
...
class FileHandlerTests(HandlerTests, unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.loggers import FileHandler
        return FileHandler
...
class RotatingFileHandlerTests(FileHandlerTests):
    ...
    def _getTargetClass(self):
        from docker_supervisor.loggers import RotatingFileHandler
...
class BoundIOTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.loggers import BoundIO
        return BoundIO
...
class LoggerTests(unittest.TestCase):
    def _getTargetClass(self):
        from docker_supervisor.loggers import Logger
        return Logger
