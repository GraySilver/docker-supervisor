...
class TestEventTypes(unittest.TestCase):
    def test_ProcessLogEvent_attributes(self):
        from docker_supervisor.events import ProcessLogEvent
    ...
    def test_ProcessLogEvent_inheritence(self):
        from docker_supervisor.events import ProcessLogEvent
        from docker_supervisor.events import Event
        self.assertTrue(
            issubclass(ProcessLogEvent, Event)
        )

    def test_ProcessLogStdoutEvent_attributes(self):
        from docker_supervisor.events import ProcessLogStdoutEvent
    ...
    def test_ProcessLogStderrEvent_attributes(self):
        from docker_supervisor.events import ProcessLogStderrEvent
    ...
    def _test_one_SupervisorStateChangeEvent(self, klass):
        from docker_supervisor.events import SupervisorStateChangeEvent
    ...
    def _test_one_TickEvent(self, klass):
        from docker_supervisor.events import TickEvent
    ...
    def test_ProcessGroupAddedEvent_attributes(self):
        from docker_supervisor.events import ProcessGroupAddedEvent
    ...
    def test_ProcessGroupRemovedEvent_attributes(self):
        from docker_supervisor.events import ProcessGroupRemovedEvent
