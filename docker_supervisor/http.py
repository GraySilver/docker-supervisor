...
from docker_supervisor.medusa import http_server
from docker_supervisor.medusa import producers
from docker_supervisor.medusa import filesys
from docker_supervisor.medusa import default_handler

from docker_supervisor.medusa.auth_handler import auth_handler
...
class supervisor_http_server(http_server.http_server):
    ...
    def prebind(self, sock, logger_object):
        ...
        from docker_supervisor.medusa import logger
    ...
    def postbind(self):
        from docker_supervisor.medusa.counter import counter
        from docker_supervisor.medusa.http_server import VERSION_STRING
